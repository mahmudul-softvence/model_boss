...
class ChallengeRejectedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    protected function payload(): array
    {
        return [
            ...
            'message' => 'Your challenge was rejected and the reserved amount has been refunded.',
        ];
    }
}
